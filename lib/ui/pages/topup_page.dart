...
class TopUpPage extends StatefulWidget {
  final PageEvent
      pageEvent; // untuk mencatat event dari page yang mana yang masuk ke topup page
                      ...
                      child: Column(
                        children: [
                          ...
                          Wrap(
                            ...
                            runSpacing: 14,
                            children: [
                              makeMoneyCard(50000, cardWidth),
                              makeMoneyCard(100000, cardWidth),
                              makeMoneyCard(150000, cardWidth),
                              makeMoneyCard(500000, cardWidth),
                              makeMoneyCard(1000000, cardWidth),
                              makeMoneyCard(2000000, cardWidth),
                            ],
                          ),
                          SizedBox(height: 100),
                          SizedBox(
                                            ...
                                            context.bloc<PageBloc>().add(
                                                GoToSuccessPage(
                                                    ...
                                                    FlutixTransaction(
                                                        ...
                                                        subtitle:
                                                            "${DateTime.now().fullday}, ${DateTime.now().month}, ${DateTime.now().year}",
                                                        time: DateTime.now(),
                                                        title:
                                                            "Top Up My Wallet")));
                                          }
